...
UPDATE josde_extensions SET params = '{\"mediaversion\":\"9213b69191252adaf19c3c1e5598cf06\"}' WHERE type = 'library' AND element = 'joomla';
...
SELECT m.id, m.title, m.module, m.position, m.content, m.showtitle, m.params, mm.menuid FROM josde_modules AS m LEFT JOIN josde_modules_menu AS mm ON mm.moduleid = m.id LEFT JOIN josde_extensions AS e ON e.element = m.module AND e.client_id = m.client_id WHERE m.published = 1 AND e.enabled = 1 AND (m.publish_up = '0000-00-00 00:00:00' OR m.publish_up <= '2018-03-26 12:55:31') AND (m.publish_down = '0000-00-00 00:00:00' OR m.publish_down >= '2018-03-26 12:55:31') AND m.access IN (1,1,2,3,6) AND m.client_id = 1 AND (mm.menuid = 0 OR mm.menuid <= 0) ORDER BY m.position, m.ordering;
